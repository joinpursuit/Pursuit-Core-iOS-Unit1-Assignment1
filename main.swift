...
print("waaaahh our first enemy, This is a trash mob")
    print("player you must type atk, or item")
...
for _ in 0...adventurelog where adventurelog < 2{
...
//    print("thank you for playing my game please rate my game")
//    choice = readLine()
//    switch choice{
//    
//}
